...
const Bitcoin = ({ item }) => {
  ...
  return (
    <div className="bg-darkGray w-[100%] md:w-[20rem] flex flex-col p-4 rounded-xl gap-y-8">
      <div className="flex flex-wrap items-center justify-between">
        <div className={`w-16 h-16 flex items-center justify-center rounded-[50%] text-blue-50`} style={{border: `1px solid ${item.color}`}}>
